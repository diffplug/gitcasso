...
export const generateMockDrafts = (): CommentTableRow[] => [
  {
    ...
    latestDraft: {
      ...
      stats: {
        ...
        links: [
          {
            text: "Issue #1233",
            url: "https://github.com/microsoft/vscode/issues/1233",
          },
    ...
    spot: withSpot({
      ...
      title:
        "Fix memory leak in extension host (why is this so hard! It's been months!)",
      type: "GH_PR_APPEND",
      unique_key: "1",
    ...
    latestDraft: {
      ...
      stats: {
        ...
        links: [
          ...
          {
            text: "Examples",
            url: "https://github.com/vercel/next.js/tree/main/examples",
          },
          {
    ...
    latestDraft: {
      ...
      stats: {
        ...
        codeBlocks: [
          ...
          {
            code: 'new Worker("./worker.mjs", { type: "module" })',
            language: "javascript",
          },
          {
          ...
          {
            code: 'interface WorkerOptions { type: "module" }',
            language: "typescript",
          },
          {
            code: 'await import("./dynamic-module.mjs")',
            language: "javascript",
          },
          {
            code: "export default function workerTask() {}",
            language: "javascript",
          },
          {
            code: "const result = await workerPromise",
            language: "javascript",
          },
        ],
        images: [
          { alt: "ESM Worker Architecture", url: "worker-architecture.png" },
        ],
        links: [
          {
          ...
          {
            text: "Related issue",
            url: "https://github.com/nodejs/node/issues/30682",
          },
        ],
      },
